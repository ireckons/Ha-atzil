            ...
            <div className="max-w-2xl mx-auto">
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-6">
                    ...
                    <fieldset className="card p-6">
                        <legend className="text-lg font-bold text-white mb-4">Personal Details</legend>
                        <div className="space-y-4">
                            <div>
                                <label htmlFor="name" className="block text-sm font-medium text-white/70 mb-1">Full Name *</label>
                                <input id="name" type="text" required value={name} onChange={(e) => setName(e.target.value)}
                                    placeholder="John Doe" className="input" autoComplete="name" />
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <textarea id="notes" rows={3} value={notes} onChange={(e) => setNotes(e.target.value)}
                                    placeholder="Special requests, details on cuts, etc..." className="input resize-none" />
                            </div>
                        </div>
                    </fieldset>
                    ...
                    {/* Pickup slot */}
                    <fieldset className="card p-6">
                        <legend className="text-lg font-bold text-white mb-4">Pickup Time *</legend>
                        {slotsLoading ? (
                            ...
                            <p className="text-white/50 text-sm">No pickup slots available. Please contact the store.</p>
                        ) : (
                            <div className="space-y-2 max-h-72 overflow-y-auto" role="radiogroup" aria-label="Select pickup time">
                    ...
                    <div className="card p-4">
                        ...
                        <p className="text-white/30 text-xs mt-1">Payment is processed in-store upon pickup</p>
                    </div>
